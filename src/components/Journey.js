        ...
        <div className="firstProject py-4 border-l border-black border-solid relative lg:flex ml-2 h-max">
          <div className="text lg:w-2/4">
            ...
            <p className=" p-2">
              ...
              communication skills, analytical abilities, and the ability to act
              independently. Able to think creatively and eager to learn. I am
              experienced in problem-solving and developing innovative solutions
              to reach business goals and objectives.
            </p>
